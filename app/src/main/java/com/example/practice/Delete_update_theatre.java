...
public class Delete_update_theatre extends AppCompatActivity {
    TextView tvInfo;
    EditText tvName;
    Button tvButton;
    Button tvButtonU;
    Button tvButtonD;
    Delete_update_theatre.MyTask mt;

    Delete_update_theatre.MyTaskU mtu;
    Delete_update_theatre.MyTaskD mtd;
    ListView lvMain;
    ...
    public void onclickF(View v) {
        mt = new Delete_update_theatre.MyTask();
    ...
    class MyTask extends AsyncTask<String, Void, ArrayList<String[]>> {
        ...
        protected ArrayList<String[]> doInBackground(String... params) {
            ...
            String total = "";
            try {
                URL githubEndpoint = new URL("http://10.0.2.2:8080/kino/theatres?name=" + params[0]);
                myConnection =
        ...
        protected void onPostExecute(ArrayList<String[]> result) {
            ...
            Delete_update_theatre.ClAdapter clAdapter = new Delete_update_theatre.ClAdapter(tvInfo.getContext(), result);
            lvMain = (ListView) findViewById(R.id.lvMain);
...
//            int n=lvMain.getChildCount();
    ...
    class ClAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                view = lInflater.inflate(R.layout.activity_adapt2, parent, false);
            }
            ;
