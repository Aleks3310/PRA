...
public class new_film extends AppCompatActivity {
    TextView tvInfo;
    EditText tvName;
    Button tvButton;
    new_film.MyTask mt;
    String line;
    String total="";
    new_film.MyTaskN mtn;
    //    ArrayList <new_film.MyTaskTF>mttf=new ArrayList <new_film.MyTaskTF>();
    new_film.MyTaskTF mttf;
    ListView lvMain;
    ...
    class MyTask extends AsyncTask<Void, Void, ArrayList<String[]>> {
        ...
        protected ArrayList<String[]> doInBackground(Void... params) {
            ...
            try {
                URL githubEndpoint = new URL("http://10.0.2.2:8080/kino/alltheatres");
                myConnection =
        ...
        protected void onPostExecute(ArrayList<String[]> result) {
            ...
            new_film.ClAdapter clAdapter=new new_film.ClAdapter(tvInfo.getContext(),result);
//            lvMain = (ListView) findViewById(R.id.lvMain);
...
//            tvInfo.setText("End");
    ...
    class MyTaskN extends AsyncTask<String, Void, String > {
        ...
        protected String doInBackground(String... params) {
            ...
            JSONObject obj=null;
            try {
                URL githubEndpoint = new URL("http://10.0.2.2:8080/kino/writefilm");
                myConnection =
                        (HttpURLConnection) githubEndpoint.openConnection();
            } catch (MalformedURLException e) {
                e.printStackTrace();
...
//                    mttf.get(m).execute(st[1],result);
    ...
    class MyTaskTF extends AsyncTask<JSONArray, Void, String > {
        ...
        protected String doInBackground(JSONArray... jsonArrays) {
            ...
            JSONObject obj=null;
            try {
                URL githubEndpoint = new URL("http://10.0.2.2:8080/kino/theatres_films");
                myConnection =
                        (HttpURLConnection) githubEndpoint.openConnection();
            } catch (MalformedURLException e) {
                e.printStackTrace();
