...
public class Delete_update_film extends AppCompatActivity {
    TextView tvInfo;
    EditText tvName;
    Button tvButton;
    Button tvButtonU;
    Button tvButtonD;
    Delete_update_film.MyTask mt;

    Delete_update_film.MyTaskU mtu;
    Delete_update_film.MyTaskD mtd;
    ListView lvMain;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_delete_update_film);
    ...
    public void onclickF(View v) {
        mt = new Delete_update_film.MyTask();
    ...
    class MyTask extends AsyncTask<String, Void, ArrayList<String[]>> {
        ...
        protected ArrayList<String[]> doInBackground(String... params) {
            ...
            String total = "";
            try {
                URL githubEndpoint = new URL("http://10.0.2.2:8080/kino/films?name=" + params[0]);
                myConnection =
        ...
        protected void onPostExecute(ArrayList<String[]> result) {
            ...
            Delete_update_film.ClAdapter clAdapter = new Delete_update_film.ClAdapter(tvInfo.getContext(), result);
            lvMain = (ListView) findViewById(R.id.lvMain);
...
//            int n=lvMain.getChildCount();
    ...
    class ClAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                view = lInflater.inflate(R.layout.activity_adapt3, parent, false);
            }
            ;
    ...
    public void onclickU(View v) {
        ...
        mtu = new Delete_update_film.MyTaskU();
        mtu.execute(JA);
    }
...
//                tvInfo.setText(str);
    ...
    public void onclickD(View v) {
        ...
        mtd = new Delete_update_film.MyTaskD();
        mtd.execute(JA);
