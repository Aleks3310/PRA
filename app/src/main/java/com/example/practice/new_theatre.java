...
public class new_theatre extends AppCompatActivity {
    TextView tvInfo;
    EditText tvName;
    EditText tvAddress;
    new_theatre.MyTask mt;
...
//          InputStream is = null;
            ...
            JSONObject obj = null;
            try {
                URL githubEndpoint = new URL("http://10.0.2.2:8080/kino/newtheatre?name=");
                myConnection =
